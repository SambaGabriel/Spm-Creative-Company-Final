          ...
          {status === 'done' ? (
            ...
            <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
              ...
              <p className="font-mono text-[10px] tracking-[0.15em] uppercase text-neutral-600 leading-relaxed pt-2">
                ...
                <a href="/terms" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white border-b border-neutral-700 hover:border-white transition-colors">Terms of Use</a>
                {' '}and{' '}
                <a href="/privacy" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white border-b border-neutral-700 hover:border-white transition-colors">Privacy Policy</a>.
              </p>
            </form>
          )}
        </Reveal>
